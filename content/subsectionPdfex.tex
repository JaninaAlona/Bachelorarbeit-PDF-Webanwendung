...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{"images/aes_addroundkey.png"}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{"images/aes_subbytes.png"}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{"images/aes_shiftrows.png"}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.8\textwidth]{"images/aes_mixcolumns.png"}
